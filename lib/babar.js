...
(function() {
  ...
  module.exports = function(points, options) {
    ...
    _ref3 = [options.caption, (_ref = options.color) != null ? _ref : 'cyan', (_ref1 = options.width) != null ? _ref1 : 80, (_ref2 = options.height) != null ? _ref2 : 15, options.xFractions, options.yFractions, options.buckets], caption = _ref3[0], color = _ref3[1], width = _ref3[2], height = _ref3[3], xFractions = _ref3[4], yFractions = _ref3[5], numBkts = _ref3[6];
    if (color !== 'ascii') {
      require('colors');
    }
    ...
    width -= lblYW;
    numBkts = Math.min(numBkts != null ? numBkts : uniqueX, width - lblYW);
